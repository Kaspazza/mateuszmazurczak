...
(def dict
  ...
  {:en
   {:homepage "Home"
    ...
    :download "Download"
    :download-progress "Downloading %1 of %2 batches..."
    :preview "Preview"
   ...
   {:homepage "Główna"
    ...
    :format-pdf "PDF (wiele kodów na stronę, format wektorowy)"
    :format-pdf-description "Kody QR jako grafika wektorowa w siatce (~20 kodów/stronę)"
    ...
    :download "Pobierz"
    :download-progress "Pobieranie %1 z %2 paczek..."
    :preview "Podgląd"
