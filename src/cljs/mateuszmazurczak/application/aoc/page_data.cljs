...
(comment
 ...
 (def solution-ids
   {:header-data {:text {:title [:i18n :advent-of-code-solutions]
    ...
    :selector-data {:selected-year 2025
                    :selected-challenge 2
                    :years-options [{:value 2025
                                     :label "2025"}
                                    {:value 2024
                                     :label "2024"}
                                    {:value 2023
    ...
    :solutions-data {:solution-ids ["30ca9c31-63bf-4713-9c7f-acb11c642d36"
                                    "e18416cf-bb7c-4b45-8bdd-2170d550dd18"
                                    "7360ecc6-2896-45bb-89fe-150a682a30ca"]
                     :loading? true
                     :gated? false
                     :user-solution-ids #{}
                     :text {:only-if-solved-no-cheating [:i18n :only-if-solved-no-cheating]
    ...
    :modal-data {:submitting? false
                 ...
                 :form {:author-name ""
                        ...
                        :challenge 1}
                 :form-errors nil
                 :text {:repo-placeholder [:i18n :repo-placeholder]
 ...
 (def solutions
   [{:author-name "Logan Turner"
     ...
     :github-profile "https://github.com/loganturner"
     :on-vote-clever [:dispatch [:aoc/vote "30ca9c31-63bf-4713-9c7f-acb11c642d36" :clever]]
     :year 2025
     :voted-clever? false
     :best-practices-count 0
     :challenge 1
     :on-vote-best-practices [:dispatch
                              [:aoc/vote "30ca9c31-63bf-4713-9c7f-acb11c642d36" :best-practices]]
     :id "30ca9c31-63bf-4713-9c7f-acb11c642d36"
     :voted-best-practices? false
     :content-type :code-snippet
     :github-username "loganturner"
     :created-at "Tue Dec 02 20:00:43 CET 2025"
     :github-username-display "@loganturner"}])
 (def theme :light)
 (def solutions-text
