             ...
             [:div {:class "space-y-4"}
              [mm-portfolio-utils/api-component-card
               {:component-name "navigation"
                ...
                :props [[":text" "string, required - Link label."]
                        [":href" "string, optional - Anchor target URL."]
                        [":on-click" "function, optional - Click callback for client-side navigation."]
                        ["note" "Provide at least one of :href or :on-click."]]}]
              [mm-portfolio-utils/api-component-card
               {:component-name "back-navigation"
                ...
                :props [[":text" "string, required - Link label."]
                        [":href" "string, optional - Anchor target URL."]
                        [":on-click" "function, optional - Click callback for client-side navigation."]
                        [":dark?" "boolean, optional (default false) - Uses dark-surface text color."]
                        ["note" "Provide at least one of :href or :on-click."]]}]
