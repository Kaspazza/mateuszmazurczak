   ...
   [:div {:class "space-y-6"}
    ...
    [:div {:class "space-y-4"}
     [mm-portfolio-utils/api-component-card {:component-name "sidebar"
                                             ...
                                             :props
                                             [[":open?" "boolean, required - Expanded/open state"]
                                              ...
                                              [":variant" "string, optional (default 'sidebar'). One of: 'sidebar' | 'floating' | 'inset'"]
                                              [":collapsible" "string, optional (default 'offcanvas'). One of: 'offcanvas' | 'icon' | 'none'"]
