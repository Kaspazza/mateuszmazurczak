...
(def dict
  ...
  {:en
   {:homepage "Home"
    ...
    "Pre-configured grid layouts for A4 paper. Larger QR codes (4-5cm+) scan better."
   ...
   {:homepage "Główna"
    ...
    :pdf-layout-description
    "Gotowe układy siatki dla papieru A4. Większe kody QR (4-5cm+) lepiej się skanują."
