(ns mateuszmazurczak.ui.header
  (:require
   ...
   [mateuszmazurczak.i18n.fe.translate          :as
                                                mateuszmazurczak-fe-translate]
...
(defn hephaistox-logo
  []
  [:a {:href (mateuszmazurczak-fe-nav/href-delta
...
(defn header
  ...
  [web-header/header {:size size
   ...
   {:title (mateuszmazurczak-fe-translate/tr :simulation)
    :href (mateuszmazurczak-fe-nav/href-delta
           ::mateuszmazurczak-routes/simulation-pitch)}
   {:title (mateuszmazurczak-fe-translate/tr :about-us)
    :href (mateuszmazurczak-fe-nav/href-delta
           ::mateuszmazurczak-routes/about-us)}
   {:title (mateuszmazurczak-fe-translate/tr :our-offers)
    :href (str (mateuszmazurczak-fe-nav/href-delta
                ::mateuszmazurczak-routes/home)
               "#offer")}])
