...
(def dict
  ...
  {:en
   {:homepage "Home"
    ...
    :size-large "Large"
    :size-option-label "%1px (~%2 print)"
    :output-format "Output Format"
    :select-format "Select format"
    :format-zip "PNG"
    :format-jpg "JPG"
    :format-pdf "PDF"
    :png-background "PNG Background"
    :select-png-background "Select background"
    :png-background-transparent "Transparent"
    :png-background-white "White"
    :png-margin "Quiet zone (modules)"
    :png-margin-description "Quiet zone around the QR code. Increase it for busier backgrounds."
    ...
    "Set columns and rows to define how many QR codes are placed on each PDF page. QR size (cm) controls each code size on paper; larger codes scan better."
    :pdf-layout-per-page-30 "30 per page (3×10, 2cm)"
    :pdf-layout-per-page-10 "10 per page (2×5, 4cm)"
    :pdf-layout-per-page-6 "6 per page (2×3, 5cm) - recommended"
    :pdf-layout-per-page-1 "1 per page (1×1, 10cm)"
    :pdf-layout-custom "Custom grid"
    ...
    :error-png-margin-invalid "PNG margin must be a non-negative integer"
   ...
   {:homepage "Główna"
    ...
    :size-large "Duży"
    :size-option-label "%1px (~%2 druk)"
    :output-format "Format Wyjściowy"
    :select-format "Wybierz format"
    :format-zip "PNG"
    :format-jpg "JPG"
    :format-pdf "PDF"
    :png-background "Tło PNG"
    :select-png-background "Wybierz tło"
    :png-background-transparent "Przezroczyste"
    :png-background-white "Białe"
    :png-margin "Cicha strefa (moduły)"
    :png-margin-description "Cicha strefa wokół kodu QR oznacza tło wychodzące poza kod qr"
    ...
    :pdf-layout-description
    "Ustaw kolumny i wiersze, aby określić ile kodów QR ma być na stronie PDF. Rozmiar QR (cm) określa wielkość pojedynczego kodu na papierze; większe kody skanują się lepiej."
    :pdf-layout-per-page-30 "30 na stronę (3×10, 2cm)"
    :pdf-layout-per-page-10 "10 na stronę (2×5, 4cm)"
    :pdf-layout-per-page-6 "6 na stronę (2×3, 5cm) - zalecane"
    :pdf-layout-per-page-1 "1 na stronę (1×1, 10cm)"
    :pdf-layout-custom "Niestandardowa siatka"
    ...
    :download "Pobierz"
    :generating-qr-codes "Generowanie %1 z %2 qr kodów..."
    :creating-pdf-document "Generowanie dokumentu PDF..."
    :packaging-files "Tworzenie archiwum ZIP..."
    :preparing-download "Finalizowanie..."
    :preview "Podgląd"
    ...
    :error-png-margin-invalid "Margines PNG musi być nieujemną liczbą całkowitą"
